...
const Nav = () => {
  ...
  console.log(theme);
  return (
    <div className="navbar bg-base-100 shadow-lg px-8 fixed z-20">
      <div className="flex-1">
        <NavLink to='/' className="btn btn-ghost gap-0 text-secondary text-2xl normal-case">
          Byte<span className="text-primary">Blaze</span>
        </NavLink>
      </div>
      <div className="flex-none">
        <ul className="menu menu-horizontal px-1 gap-5 mr-3">
