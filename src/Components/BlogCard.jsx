...
const BlogCard = ({blog, deletable, handleDelete}) => {
    ...
    deletable && <div onClick={()=> handleDelete(id)} className="absolute right-20 bg-primary p-3 -top-5 rounded-full hover:scale-105 cursor-pointer hover:bg-secondary group"><MdDeleteForever size={20} className="text-secondary group-hover:text-primary" /></div>
